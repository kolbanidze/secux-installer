...
class Locale:
    def __init__(self, language):
        if language == "en":
            ...
            self.systeminstallto = "System drive"
            ...
            self.online_or_offline_message = "The installation image contains all the packages needed for installation. You can download the latest versions of packages from the network (online) or install pre-installed ones (offline)"
            self.offline = "Offline"
            self.online = "Online"
            self.package_source = "Select a package installation source.\nOnline - the newest versions of applications will\nbe downloaded from the Internet (recommended).\nOffline - packages already downloaded\nto this offline image will be installed.\nEnter - online."
            self.package_source_status = "Current image"
            self.apps_label = "Installing software"
            self.secure_label = "Trusting your own Secure Boot keys. Custom Mode must be enabled"
            self.less_secure_label = "Trusting Microsoft's keys. Using SHIM and your own MOK"
            ...
            self.erase_all_and_install = "Автоматически: стереть весь диск и установить ОС"
            self.manual = "Вручную"
