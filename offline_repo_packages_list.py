...
PACKAGES += " vte4 base-devel cmake python-opencv python-numpy keepassxc libreoffice apparmor ufw python-darkdetect python-packaging python-setuptools python-dotenv python-dlib"
