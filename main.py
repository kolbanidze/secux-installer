...
class App(CTk):
    ...
    def __check_network_connection(self) -> bool:
        try:
            answ = get("https://gstatic.com/generate_204", timeout=5)
    ...
    def mok_stage(self):
        title = CTkLabel(self, text=self.lang.mok_key, font=(None, 16, "bold"))
    ...
    def begin_installation(self):
        ...
        if self.setup_information["DE"] == "GNOME":
            ...
            self._execute(['sed', '-i', 's/^Current=.*/Current=breeze/', f'{mount_point}/usr/lib/sddm/sddm.conf.d/default.conf'])
